...
/*  In-memory for now — the catalog is loaded fully by `getAllProducts`.      */
/*  Move into a query when catalogs grow past a few hundred SKUs.             */
/* ========================================================================== */
...
const columns: Column<GetProduct>[] = [
    {
        ...
        cell: (p) => (
            <Link
                href={`/stores/${p.storeId}/owner/products/${p.id}`}
...
function RowActions({
    ...
    const base = `/stores/${storeId}/owner/products/${productId}`;
...
export default async function ProductsPage({
    params,
    searchParams,
}: PageProps<"/stores/[storeId]/owner/products">) {
    ...
    if (result instanceof AppError) {
        return (
            <ErrorState
                ...
                action={
                    <Link
                        href={`/stores/${storeId}/owner/products`}
