...
export type StorageHash =
  StorageHashBase<'f6d7e78a98eb02a94fa7e08c4104f025bd534e749299a7eaffc6b89499b059db'>;
export type ExecutionHash =
  ExecutionHashBase<'e123ff5fce7ea428801cde18721f66296f16b2e15cba27d142a00a242a774c70'>;
...
export type FieldOutputTypes = {
  readonly public: {
    ...
    readonly Sale: {
      ...
      readonly invoiceNumber: CodecTypes['pg/text@1']['output'];
      readonly saleDate: CodecTypes['pg/timestamptz-temporal@1']['output'];
      readonly subtotal: CodecTypes['pg/float8@1']['output'];
      readonly discountAmount: CodecTypes['pg/float8@1']['output'];
      readonly taxAmount: CodecTypes['pg/float8@1']['output'];
      readonly totalAmount: CodecTypes['pg/float8@1']['output'];
    ...
    readonly StoreMembership: {
      ...
      readonly status: 'PENDING' | 'ACTIVE' | 'REJECTED' | 'INVALIDATED';
      readonly createdAt: CodecTypes['pg/timestamptz-temporal@1']['output'];
      readonly updatedAt: CodecTypes['pg/timestamptz-temporal@1']['output'];
    };
    readonly Supplier: {
    ...
    readonly User: {
      readonly id: CodecTypes['pg/uuid@1']['output'];
      readonly kindeId: CodecTypes['pg/text@1']['output'];
      readonly email: CodecTypes['pg/text@1']['output'] | null;
...
export type FieldInputTypes = {
  readonly public: {
    ...
    readonly Sale: {
      ...
      readonly invoiceNumber: CodecTypes['pg/text@1']['input'];
      readonly saleDate: CodecTypes['pg/timestamptz-temporal@1']['input'];
      readonly subtotal: CodecTypes['pg/float8@1']['input'];
      readonly discountAmount: CodecTypes['pg/float8@1']['input'];
      readonly taxAmount: CodecTypes['pg/float8@1']['input'];
      readonly totalAmount: CodecTypes['pg/float8@1']['input'];
    ...
    readonly User: {
      readonly id: CodecTypes['pg/uuid@1']['input'];
      readonly kindeId: CodecTypes['pg/text@1']['input'];
      readonly email: CodecTypes['pg/text@1']['input'] | null;
        ...
        readonly entries: {
          readonly table: {
            ...
            readonly sale: {
              columns: {
                ...
                readonly invoiceNumber: {
                  ...
                  readonly default: {
                    readonly kind: 'function';
                    readonly expression: 'generate_sale_invoice_number()';
                  };
                };
                readonly saleDate: {
                  readonly nativeType: 'timestamptz';
              ...
              indexes: readonly [
                {
                  readonly name: 'sale_storeId_idx_c545737d';
                  readonly prefix: 'sale_storeId_idx';
                  readonly columns: readonly ['storeId'];
                  readonly unique: false;
                },
                {
                  readonly name: 'sale_createdById_idx_8bf640ed';
                  readonly prefix: 'sale_createdById_idx';
                  readonly columns: readonly ['createdById'];
                  readonly unique: false;
                },
                {
                ...
                {
                  readonly name: 'sale_storeId_saleDate_idx_1ad92b78';
                  readonly prefix: 'sale_storeId_saleDate_idx';
                  readonly columns: readonly ['storeId', 'saleDate'];
                  readonly unique: false;
                },
              ];
              foreignKeys: readonly [
            ...
            readonly saleItem: {
              ...
              indexes: readonly [
                ...
                {
                  readonly name: 'saleItem_productId_idx_5858600a';
                  readonly prefix: 'saleItem_productId_idx';
                  readonly columns: readonly ['productId'];
                  readonly unique: false;
                },
              ];
            ...
            readonly store: {
              columns: {
                ...
                readonly currency: {
                  ...
                  readonly default: {
                    readonly kind: 'literal';
                    readonly value: DefaultLiteralValue<'pg/text@1', 'DZ'>;
                  };
                };
                readonly timezone: {
                  readonly nativeType: 'text';
            ...
            readonly user: {
              ...
              primaryKey: { readonly columns: readonly ['id'] };
              uniques: readonly [{ readonly columns: readonly ['kindeId'] }];
              indexes: readonly [
                {
          ...
          readonly valueSet: {
            ...
            readonly MembershipStatus: {
              readonly kind: 'valueSet';
              readonly values: readonly ['PENDING', 'ACTIVE', 'REJECTED', 'INVALIDATED'];
            };
            readonly StoreRole: {
              readonly kind: 'valueSet';
        ...
        readonly enum: {
          ...
          readonly MembershipStatus: {
            ...
            readonly members: readonly [
              ...
              { readonly name: 'INVALIDATED'; readonly value: 'INVALIDATED' },
            ];
          };
        };
      };
