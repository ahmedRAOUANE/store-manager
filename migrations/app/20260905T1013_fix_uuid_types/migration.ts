    ...
    return [
      ...
      this.createTable({
        ...
        columns: [
          ...
          col('id', 'uuid', { notNull: true, codecRef: { codecId: 'pg/uuid@1' } }),
          col('invoiceNumber', 'text', { codecRef: { codecId: 'pg/text@1' } }),
      ...
      this.addColumn({
        schema: 'public',
        table: 'user',
        column: col('storeId', 'uuid', { codecRef: { codecId: 'pg/uuid@1' } }),
      }),
      this.dataTransform(endContract, 'backfill-user-storeId', {
        check: () => placeholder('backfill-user-storeId:check'),
        run: () => placeholder('backfill-user-storeId:run'),
      }),
      this.setNotNull({ schema: 'public', table: 'user', column: 'storeId' }),
